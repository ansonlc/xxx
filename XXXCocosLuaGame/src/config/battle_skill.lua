...
local SkillTable = {
    ...
    [1003] = {skillID=1003,skillQuality=3,skillName='Wind Arrow',runeCostTable= {air=2,earth=0,water=0,fire=0},animationID = nil,particleID = nil,growthRatio = 2,CD = 1,effectTable ={effectID1=1002,effectValue1=50,effectID2=nil,effectValue2=nil,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Advanced Wind Attack'},
    [1004] = {skillID=1004,skillQuality=2,skillName='Stone Sword',runeCostTable= {air=0,earth=1,water=0,fire=0},animationID = nil,particleID = nil,growthRatio = 2,CD = 1,effectTable ={effectID1=1003,effectValue1=25,effectID2=nil,effectValue2=nil,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Basic Stone Attack'},
    [1005] = {skillID=1005,skillQuality=3,skillName='Stone Arrow',runeCostTable= {air=0,earth=2,water=0,fire=0},animationID = nil,particleID = nil,growthRatio = 2,CD = 1,effectTable ={effectID1=1003,effectValue1=50,effectID2=nil,effectValue2=nil,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Advanced Stone Attack'},
    [1006] = {skillID=1006,skillQuality=2,skillName='Water Sword',runeCostTable= {air=0,earth=0,water=1,fire=0},animationID = nil,particleID = nil,growthRatio = 2,CD = 1,effectTable ={effectID1=1004,effectValue1=25,effectID2=nil,effectValue2=nil,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Basic Water Attack'},
    [1007] = {skillID=1007,skillQuality=3,skillName='Water Arrow',runeCostTable= {air=0,earth=0,water=2,fire=0},animationID = nil,particleID = nil,growthRatio = 2,CD = 1,effectTable ={effectID1=1004,effectValue1=50,effectID2=nil,effectValue2=nil,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Advanced Water Attack'},
    [1008] = {skillID=1008,skillQuality=2,skillName='Fire Sword',runeCostTable= {air=0,earth=0,water=0,fire=1},animationID = nil,particleID = nil,growthRatio = 2,CD = 1,effectTable ={effectID1=1005,effectValue1=25,effectID2=nil,effectValue2=nil,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Basic Fire Attack'},
