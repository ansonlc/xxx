...
local SkillTable = {
    ...
    -- Shell skills
    [1200] = {skillID=1200,skillQuality=4,skillName='Minor Shell',runeCostTable = {air=0,earth=3,water=0,fire=0},animationID = nil,particleID = nil,growthRatio = 1,CD = 5,effectTable={effectID1=1020,effectValue1=40,effectID2=nil,effectValue2=nil,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Minor Shell'},
    -- Recovery skill
    [1300] = {skillID=1300,skillQuality=5,skillName='Minor Recovery',runeCostTable = {air=2,earth=0,water=2,fire=0},animationID = nil,particleID = nil,growthRatio = 1,CD = 5,effectTable={effectID1=1030,effectValue1=100,effectID2=1030,effectValue2=9,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Minor Recovery'},
    -- Bleed skills
    [1400] = {skillID=1400,skillQuality=6,skillName='Minor Bleed',runeCostTable = {air=0,earth=0,water=0,fire=2},animationID = nil,particleID = nil,growthRatio = 1,CD = 3,effectTable={effectID1=1040,effectValue1=50,effectID2=1040,effectValue2=10,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Minor Bleed'},
    -- Silence skills
    ...
    -- Fear skills
    [1900] = {skillID=1900,skillQuality=7,skillName='Minor Fear',runeCostTable = {air=0,earth=5,water=0,fire=0},animationID = nil,particleID = nil,growthRatio = 1,CD = 10,effectTable={effectID1=1090,effectValue1=0.5,effectID2=1090,effectValue2=10,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Minor Fear'},   
    -- Purify skills
    ...
    -- Disperse skills
    [2100] = {skillID=2100,skillQuality=1,skillName='Minor Disperse',runeCostTable = {air=3,earth=3,water=3,fire=3},animationID = nil,particleID = nil,growthRatio = 1, CD = 10, effectTable={effectID1=1110,effectValue1=nil,effectID2=nil,effectValue2=nil,effectID3=nil,effectValue3=nil},skillSum='',skillDesc='Minor Fear'},
