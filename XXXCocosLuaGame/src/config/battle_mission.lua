...
local battle_mission = {
    ...
    [1]={id=101101,missionName="Blessing Wind",levelMin=1,preMissionId=0,missionType=0,missionBossType=0,missionBossID=1001},
    [2]={id=101102,missionName="Middle Earth",levelMin=1,preMissionId=0,missionType=0,missionBossType=0,missionBossID=1002},
    ...
    [6]={id=101106,missionName="And Then There Were None",levelMin=1,preMissionId=0,missionType=0,missionBossType=0,missionBossID=1006},
    --[7]={id=101107,missionName=">_<",levelMin=1,preMissionId=0,missionType=0,missionBossType=0,missionBossID=1007},
}
